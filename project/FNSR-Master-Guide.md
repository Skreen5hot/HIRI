...
| Attribute | Value |
|-----------|-------|
| **Document ID** | `fnsr-master-guide-v1.0` |
| **Version** | 1.0.0 |
| **Status** | NORMATIVE |
...
FNSR's 37 services organize into eight logical domains. Each domain represents a coherent capability cluster. Together, they form the architecture of a synthetic person.
...
*Services: MDRE (modal/deontic reasoning engine), AES (abductive hypothesis generation), DES (defeasible defaults), CSS (counterfactual simulation), APS (analogical precedent matching), OCE (ontological constraint checking)*
...
|-----------|-------|
| Total services | 37 |
| Services with formal specifications | 27 |
| Services requiring new specifications | 8 |
| Services in draft | 2 |
| Philosophical foundation documents | 5 |
| Architecture specifications | 4 |
| Infrastructure specifications | 8 |
| Total specification documents | 44+ |
...
- Portfolio Planning Document (v3.0)
